<footer class="footer">
    <div class="footer__grid">
        <div class="footer_contenido">
            ...
            <p class="footer__texto">DevWebCamp es una conferencia para desarrolladores de todos los niveles y se lleva a cabo de forma presencial y en lina</p>
    ...
    <p class="footer__copyright">
        DevWebCamp
        <spam class="footer__copyright--regular">
