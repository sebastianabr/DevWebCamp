<main class="paquetes">
    ...
    <div class="paquetes__grid">
        ...
        <div class="paquete">
            ...
            <ul class="paquete__lista">
                <li class="paquete__elemento">Acceso Prescencial a DevWebCamp</li>
                <li class="paquete__elemento">Pase por 2 días</li>
                <li class="paquete__elemento">Accceso a Talleres y Conferencias</li>
                <li class="paquete__elemento">Accceso a las grabaciones</li>
